...
- [ ] 1. Set up foundational casting interfaces using existing data structures
  ...
  - [x] 1.2 Define TypeScript casting interfaces in frontend
...
- [ ] 2. Implement Google Cast integration
  - [x] 2.1 Create Google Cast SDK integration layer
  ...
  - [x] 2.2 Build custom Cast Receiver application
  ...
  - [x] 2.3 Implement Cast UI components for sender application
